(function(){
    function addOpacity(){
        ...
        document.querySelector("#gamb-menu").classList.add("opacity0-3");
        document.querySelector("#top-short-menu").classList.add("opacity0-3");
        document.querySelector("#short-menu").classList.add("opacity0-3");
        document.querySelector("#main-not-full").classList.add("opacity0-3"); 
    ...
    function removeOpacity(){
        ...
        document.querySelector("#gamb-menu").classList.remove("opacity0-3");
        document.querySelector("#top-short-menu").classList.remove("opacity0-3");
        document.querySelector("#short-menu").classList.remove("opacity0-3");
        document.querySelector("#main-not-full").classList.remove("opacity0-3"); 
    }
